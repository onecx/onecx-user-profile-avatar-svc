...
class ImageDAOTest extends AbstractTest {
    ...
    void methodExceptionTests() {
        methodExceptionTests(() -> dao.deleteQueryByRefId("test"),
                AvatarDAO.ErrorKeys.FAILED_TO_DELETE_BY_REF_ID_QUERY);
        methodExceptionTests(() -> dao.findByUserIdAndRefType("test", "test"),
                AvatarDAO.ErrorKeys.FIND_ENTITY_BY_REF_ID_REF_TYPE_FAILED);
    }
